...
<p align="center">
Este é meu projeto de portfólio principal, desenvolvido para aplicar na prática os conceitos de <strong>Programação Orientada a Objetos</strong> em Java.
</p>
<p align="center">
<strong>Conceitos aplicados:</strong> Arquitetura em Camadas (Model, View, DAO), Conexão com Banco de Dados (JDBC) e Manipulação de Dados (CRUD).
</p>
<p align="center">
